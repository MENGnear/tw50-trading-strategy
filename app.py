...
# 檔案名稱 : app.py
# 程式版本 : TW50_V3.29 (深度對齊 MON_V3.0.1 視覺與 Inline HTML 結構)
# ==========================================================
...
# ==============================
# Prt.02 頂級深色優化視覺 CSS (100% 物理移植 MON_V3.0.1)
# ==============================
st.markdown(r'''
<style>
/* =========================================
...
if combined_df.empty:
    ...
    with st.sidebar:
        ...
        # 2. 新增監測股票 (對齊 MON_V3.0.1 的 Inline HTML 樣式)
        with st.container(border=True):
            st.markdown("### ➕ 新增監測股票")
            st.markdown("<div style='color:#38bdf8; font-size:1.0rem; font-weight:700; margin-top:5px; margin-bottom:5px;'>✍️ 手動輸入股票</div>", unsafe_allow_html=True)
        ...
        # 6. 系統狀態與版本 (對齊 MON_V3.0.1 的 Inline HTML)
        st.markdown(
            f"""
